        ...
        <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-8 text-gray-600 '>
            <div className='flex gap-8 '>
                <div className='flex flex-col gap-4 '>
                    ...
                    <label htmlFor='song'>
                        <img src={song ? added : uploadsong} className='w-24 cursor-pointer' alt="" />
                    </label>
                </div>
                <div className='flex flex-col gap-4 '>
                    <p>Upload Image</p>
                    ...
                    <label htmlFor='image'>
                        <img src={image ? URL.createObjectURL(image) : uploadarea} alt="" className='w-24 cursor-pointer' />
                    </label>
                </div>
            </div>
